...
func NewMetrics(reg prometheus.Registerer) *Metrics {
	...
	reg.MustRegister(m.PollTotal, m.PollDuration, m.DiscoveryDelay, m.LastPollSuccess, m.DeliveryTotal, m.DeliveryDuration, m.OutboxDepth, m.OldestOutboxAge, m.AuthState)
	return m
}
