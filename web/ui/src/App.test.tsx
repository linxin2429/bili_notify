...
describe('dynamic history previews', () => {
  ...
  const cases: { name: string; item: DynamicHistoryItem; text: string; images: number }[] = [
    { name: '纯文本', item: { ...base, summary: '完整的纯文本正文' }, text: '完整的纯文本正文', images: 0 },
    { name: '单图', item: { ...base, type: 'DYNAMIC_TYPE_DRAW', media: [{ kind: 'image', url: 'https://example.com/1.jpg', width: 800, height: 600 }] }, text: '测试 UP', images: 1 },
    { name: '多图', item: { ...base, type: 'DYNAMIC_TYPE_DRAW', media: [{ kind: 'image', url: 'https://example.com/1.jpg' }, { kind: 'image', url: 'https://example.com/2.jpg' }] }, text: '测试 UP', images: 2 },
    { name: '视频', item: { ...base, type: 'DYNAMIC_TYPE_AV', title: '视频标题', media: [{ kind: 'cover', url: 'https://example.com/cover.jpg' }] }, text: '视频标题', images: 1 },
...
describe('dynamic history response validation', () => {
  it.each([
    { name: 'accepts media preview', item: { id: '1', uid: '42', up_name: 'UP', type: 'DYNAMIC_TYPE_DRAW', published_at: '2026-01-01T00:00:00Z', discovered_at: '2026-01-01T00:00:01Z', baseline: false, media: [{ kind: 'image', url: 'https://example.com/1.jpg' }] }, valid: true },
