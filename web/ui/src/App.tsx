...
function useThemePreference() {
  ...
  const theme = useMemo(() => createTheme({ palette: { mode, primary: { main: '#fb7299' }, secondary: { main: '#23ade5' }, background: mode === 'dark' ? { default: '#101116', paper: '#191b22' } : { default: '#f6f7fb', paper: '#ffffff' } }, shape: { borderRadius: 14 }, typography: { fontFamily: 'Inter, "Noto Sans SC", "Microsoft YaHei", system-ui, sans-serif' }, components: { MuiButton: { styleOverrides: { root: { minHeight: 42, textTransform: 'none', fontWeight: 650 } } }, MuiIconButton: { styleOverrides: { root: { minWidth: 44, minHeight: 44 } } }, MuiCard: { styleOverrides: { root: { border: mode === 'dark' ? '1px solid #2b2e39' : '1px solid #e7e9f1', boxShadow: 'none' } } } } }), [mode])
